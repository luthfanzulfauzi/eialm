      ...
      ? prisma.product.findMany({
          where: {
            OR: [
              ...
              { dataClassification: contains },
              { complianceScope: contains },
              { controlNotes: contains },
              { categoryOption: { value: contains } },
              { businessDomainOption: { value: contains } },
              { supportTeamOption: { value: contains } },
              { businessOwnerOption: { value: contains } },
              { technicalOwnerUser: { name: contains } },
              { technicalOwnerUser: { email: contains } },
              { ips: { some: { address: contains } } },
              { locations: { some: { name: contains } } },
              { locations: { some: { address: contains } } },
            ],
          },
          select: {
            id: true,
